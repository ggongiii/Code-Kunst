...
public class BoardInfoBean {
	...
	private String board_Info_name_en;
	
	
	public String getBoard_Info_name_en() {
		return board_Info_name_en;
	}
	public void setBoard_Info_name_en(String board_Info_name_en) {
		this.board_Info_name_en = board_Info_name_en;
	}
